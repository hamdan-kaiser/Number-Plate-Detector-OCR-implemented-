...
public class MainFragment extends Fragment
    ...
    public void updateCurrentCropViewOptions() {
        ...
        ((PhotoEditActivity) Objects.requireNonNull(getActivity())).setCurrentOptions(options);
    }
    ...
    public void onAttach(Context context) {
        ...
        ((PhotoEditActivity) Objects.requireNonNull(getActivity())).setCurrentFragment(this);
    }
